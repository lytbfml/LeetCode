...
/**
 * Binary search tree implementation of the Set interface. The contains() and remove() methods of
 * AbstractSet are overridden to search the tree without using the iterator.
 */
public class BSTSet<E extends Comparable<? super E>> extends AbstractSet<E>
{
	...
	/**
	 * Returns the node containing key, or null if the key is not found in the tree.
	 * 
	 * @param key
	 ...
	 * 
	 * @param n
	 * @return the successor of the given node in this tree, or null if there is no successor
	 */
	...
	/**
	 * Removes the given node, preserving the binary search tree property of the tree.
	 * 
	 * @param n
	 *            node to be removed
	 */
	...
	/**
	 * Returns a representation of this tree as a multi-line string. The tree is drawn with the root
	 * at the left and children are shown top-to-bottom. Leaves are marked with a "-" and non-leaves
	 * are marked with a "+".
	 */
	@Override
	...
	/**
	 * Preorder traversal of the tree that builds a string representation in the given
	 * StringBuilder.
	 * 
	 * @param n
	...
	/**
	 * Iterator implementation for this binary search tree. The elements are returned in ascending
	 * order according to their natural ordering.
	 */
	private class BSTIterator implements Iterator<E>
	{
		...
		/**
		 * Node returned by last call to next() and available for removal. This field is null when
		 * no node is available to be removed.
		 */
