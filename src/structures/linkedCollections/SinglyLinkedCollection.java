package structures.linkedCollections;
...
public class SinglyLinkedCollection<E> extends AbstractCollection<E> {
	...
	private class LinkedIterator implements Iterator<E> {
		...
		public E next() {
			...
			// we know size > 0 and either cursor is null or cursor.next is non-null
			if (cursor == null) {
		...
		public void remove() {
			...
			// and on the first line of next(), hasNext() must have returned true.
			if (previous == null) {
