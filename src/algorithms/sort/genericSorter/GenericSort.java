package algorithms.sort.genericSorter;
...
public class GenericSort {
	 ...
	 * of using "<" to compare elements, we use the fact that Structures.String
	 * implements the Comparable interface, and therefore has a method
	 * compareTo().  Also, the temp variable is changed to type Structures.String.
	...
	public static void selectionSort(String[] arr) {
		for (int i = 0; i < arr.length - 1; ++i) {
			...
			// int changed to Structures.String
			String temp = arr[i];
			arr[i] = arr[minIndex];
			arr[minIndex] = temp;
		}
	 ...
	 * ordering provided in the Structures.String class.
	 */
	...
	public static <T> void selectionSort(T[] arr, Comparator<? super T> comp) {
		for (int i = 0; i < arr.length - 1; ++i) {
			...
			// Structures.String is changed to T
			T temp = arr[i];
			arr[i] = arr[minIndex];
			arr[minIndex] = temp;
		}
